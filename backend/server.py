...
async def root():
    preview_url = os.environ.get("preview_endpoint", "https://1a9a88ed-adf2-4970-936f-f3e05b243feb.preview.emergentagent.com")
    html_content = f"""
    <!DOCTYPE html>
    <html>
    <head>
...
async def site_links():
    ...
    <body>
        ...
        <div class="link-section">
            ...
            <a class="button" href="https://1a9a88ed-adf2-4970-936f-f3e05b243feb.preview.emergentagent.com/" target="_blank">Open Original Site</a>
            <p>URL: <code class="code">https://1a9a88ed-adf2-4970-936f-f3e05b243feb.preview.emergentagent.com/</code></p>
        </div>
