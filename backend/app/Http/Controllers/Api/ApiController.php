...
class ApiController extends Controller
{
    ...
    {
        $previewUrl = env('PREVIEW_ENDPOINT', 'https://57d6abf0-3743-4d4f-8642-76e42ef1dc2d.preview.emergentagent.com');
    ...
    public function links()
    {
        ...
        <body>
            ...
            <div class="link-section">
                ...
                <a class="button" href="https://57d6abf0-3743-4d4f-8642-76e42ef1dc2d.preview.emergentagent.com/" target="_blank">Open Original Site</a>
                <p>URL: <code class="code">https://57d6abf0-3743-4d4f-8642-76e42ef1dc2d.preview.emergentagent.com/</code></p>
            </div>
