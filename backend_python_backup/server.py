...
async def root():
    preview_url = os.environ.get("preview_endpoint", "https://014f8e48-d857-4a02-8616-4eab2e30ac63.preview.emergentagent.com")
    html_content = f"""
    <!DOCTYPE html>
    <html>
    <head>
...
async def site_links():
    ...
    <body>
        ...
        <div class="link-section">
            ...
            <a class="button" href="https://014f8e48-d857-4a02-8616-4eab2e30ac63.preview.emergentagent.com/" target="_blank">Open Original Site</a>
            <p>URL: <code class="code">https://014f8e48-d857-4a02-8616-4eab2e30ac63.preview.emergentagent.com/</code></p>
        </div>
